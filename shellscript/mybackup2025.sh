...
cp -r ~/shellscript/ ~/mybackup-temp
...
tar -czvf ~/debianbackup/shellscript-$(date +%Y%m%d-%H%M).tar.gz ~/mybackup-temp/shellscript/
...
rm -rf ~/mybackup-temp/shellscript ~/mybackup-temp/temp
