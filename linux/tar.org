...
常见打包压缩文件
+ windows  .rar   .zip   .7z
+ Linux       .tar  .tar.gz  .tar.bz2 .tar.Xz  .gz   .bz2 Xz
...
+ .tgz和.tar.gz代表tar调用gzip来完成打包和压缩的格式
+ .tbz和.tar.bz2代表tar调用bzip2来完成打包和压缩的格式
+ .taz和.tar.Z代表tar调用compress来完成打包和压缩的格式
+ .tar代表没有经过压缩的打包文件
+ .zip代表zip压缩格式
+ rar代表rar格式
+ 7z代表用7zip软件压缩的格式
...
*tar.Xz文件可分成两部解压,由于不常用,有的教程也说可以直接-xvjf来解压,我没试过.
