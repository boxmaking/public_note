...
#https代理
youtube-dl --proxy https://127.0.0.1:8118 https://www.youtube.com/watch?v=6_gLU_OStK0
#+END_SRC
...
3. 第一列是 id，第二列是文件格式，后面是视频信息。
   ...
   mp4 + m4a 会合成为一个 mp4 文件， mp4 + webm 会兼容合成为 .mkv 文件，一般为了方便视频以后上传什么的我都选择 mp4 + m4a 组合。
